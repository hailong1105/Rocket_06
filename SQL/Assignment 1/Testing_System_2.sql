...
values
(1, 'abc@gmail.com', 'Nam0102', 'Nguyen Van Nam', 3, 1, '2021-02-01'),
(2, 'bcd@gmail.com', 'Linh0203', 'Nguyen Thi Khanh Linh', 1, 1, '2021-03-02'),
(3, 'cde@gmail.com', 'Minh0304', 'Nguyen Tien Minh', 3, 4, '2021-04-03'),
(4, 'def@gmail.com', 'Hang0405', 'Nguyen Minh Hang', 4, 2, '2021-05-04'),
(5, 'efg@gmail.com', 'Thang0506', 'Nguyen Viet Thang', 5, 2, '2021-06-05');
...
values
(1, Câu hỏi thứ nhất, 12, 11, '2021-04-30'),
(2, Câu hỏi thứ hai, 13, 12, '2021-05-21'),
(3, Câu hỏi thứ ba, 14, 13, '2021-06-22'),
(4, Câu hỏi thứ tư, 15, 14, '2021-07-23'),
(5, Câu hỏi thứ năm, 16, 15, '2021-10-25');
